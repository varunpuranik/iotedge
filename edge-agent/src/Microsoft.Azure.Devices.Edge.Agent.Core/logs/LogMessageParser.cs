...
namespace Microsoft.Azure.Devices.Edge.Agent.Core.Logs
{
    ...
    public class LogMessageParser
    {
        ...
        public LogMessageParser(string iotHubName, string deviceId, string moduleId)
        {
        ...
        public ModuleLogMessage Parse(ByteString byteString) =>
            ToLogMessage(byteString, this.iotHubName, this.deviceId, this.moduleId);

        static ModuleLogMessage ToLogMessage(ByteString arg, string iotHubName, string deviceId, string moduleId)
        {
